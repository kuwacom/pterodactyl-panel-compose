        ...
        >
            ...
            {isAdmin ? (
                <>
                    ...
                    <p css={tw`mt-4`}>このサーバーはプロセスまたはメモリの上限に達しました。</p>
                    <p css={tw`mt-4`}>
                        Wingsの設定ファイル <code css={tw`font-mono bg-neutral-900`}>config.yml</code> の
                        <code css={tw`font-mono bg-neutral-900`}>container_pid_limit</code> を増やすことで解決する可能性があります。
                    </p>
                    <p css={tw`mt-4`}>
                        <b>注意: 設定ファイルの変更を反映するにはWingsを再起動する必要があります</b>
                    </p>
                ...
                <>
                    ...
                    <p css={tw`mt-4`}>
                        このサーバーは割り当てられたリソースを超えて使用しようとしています。管理者に連絡し、以下のエラーをお伝えください。
                    </p>
                    <p css={tw`mt-4`}>
