            ...
            {hash.replace(/^#/, '').endsWith('.pteroignore') && (
                <div css={tw`mb-4 p-4 border-l-4 bg-neutral-900 rounded border-cyan-400`}>
                    <p css={tw`text-neutral-300 text-sm`}>
                        ...
                        ファイルを編集中しています。ここに記載されたファイルやディレクトリはバックアップから除外されます。
                        アスタリスク (<code css={tw`font-mono bg-black rounded py-px px-1`}>*</code>) を使った
                        ワイルドカードがサポートされています。先頭に感嘆符 (
                        <code css={tw`font-mono bg-black rounded py-px px-1`}>!</code>) をつけることで、
                        以前のルールを否定できます。
                   </p>
                </div>
            )}
