...
export default ScheduleCronRow;
            <p className={'text-2xs text-neutral-500 uppercase'}>分</p>
            <p className={'text-2xs text-neutral-500 uppercase'}>時</p>
            <p className={'text-2xs text-neutral-500 uppercase'}>日(月)</p>
            <p className={'text-2xs text-neutral-500 uppercase'}>月</p>
            <p className={'text-2xs text-neutral-500 uppercase'}>日(週)</p>
