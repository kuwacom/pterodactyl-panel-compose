...
@section('content-header')
    <h1>{{ $node->name }}<small>ノードの設定を構成します。</small></h1>
    <ol class="breadcrumb">
    ...
    <div class="row">
                ...
                <div class="box-body row">
                    <div class="form-group col-xs-12">
                        ...
                        <div>
                            ...
                            <p class="text-muted"><small>文字制限: <code>a-zA-Z0-9_.-</code> および <code>[スペース]</code>（最小1、最大100文字）。</small></p>
                        </div>
                    </div>
                    <div class="form-group col-xs-12">
                    ...
                    <div class="form-group col-xs-12">
                        ...
                        <p class="text-muted"><small>デーモンへの接続に使用するドメイン名（例: <code>node.example.com</code>）を入力してください。このノードでSSLを使用しない場合のみ、IPアドレスを使用できます。
                                <a tabindex="0" data-toggle="popover" data-trigger="focus" title="なぜFQDNが必要ですか？" data-content="サーバーとこのノード間の通信を保護するためにSSLを使用します。IPアドレスにはSSL証明書を発行できないため、FQDNを提供する必要があります。">なぜ？</a>
                            </small></p>
                    </div>
                    <div class="form-group col-xs-12">
                        <label class="form-label"><span class="label label-warning"><i class="fa fa-power-off"></i></span> SSL通信</label>
                        <div>
                    ...
                    <div class="form-group col-xs-12">
                        <label class="form-label"><span class="label label-warning"><i class="fa fa-power-off"></i></span> プロキシ背後</label>
                        <div>
                            <div class="radio radio-success radio-inline">
                    ...
                    <div class="form-group col-xs-12">
                        ...
                        <p class="text-muted small">ノードが「メンテナンス中」としてマークされている場合、ユーザーはこのノード上のサーバーにアクセスできません。</p>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-xs-12">
                        <div class="row">
                            <div class="form-group col-xs-6">
                                <label for="memory" class="control-label">総メモリ</label>
                            ...
                            <div class="form-group col-xs-6">
                                <label for="memory_overallocate" class="control-label">割り当て超過</label>
                                <div class="input-group">
                        ...
                        <p class="text-muted small">このノードでサーバー割り当てに利用可能なメモリの総量を入力してください。設定された制限を超えて許可するメモリ量を決める割合（％）も指定できます。</p>
                    </div>
                    <div class="col-xs-12">
                        <div class="row">
                            <div class="form-group col-xs-6">
                                <label for="disk" class="control-label">総ディスク容量</label>
                                <div class="input-group">
                            ...
                            <div class="form-group col-xs-6">
                                <label for="disk_overallocate" class="control-label">割り当て超過</label>
                                <div class="input-group">
                        ...
                        <p class="text-muted small">このノードでサーバー割り当てに利用可能なディスク容量の総量を入力してください。設定された制限を超えて許可するディスク容量を決める割合（％）も指定できます。</p>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-sm-6">
            <div class="box">
                ...
                <div class="box-body row">
                    <div class="form-group col-xs-12">
                        <label for="disk_overallocate" class="control-label">Webアップロードの最大ファイルサイズ</label>
                        <div class="input-group">
                            <input type="text" name="upload_size" class="form-control" value="{{ old('upload_size', $node->upload_size) }}"/>
                            <span class="input-group-addon">MiB</span>
                        </div>
                        <p class="text-muted"><small>Webベースのファイルマネージャーからアップロードできるファイルの最大サイズを入力してください。</small></p>
                    </div>
                    <div class="col-xs-12">
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <p class="text-muted"><small>デーモンは独自のSFTP管理コンテナを実行し、メインの物理サーバー上のSSHdプロセスを使用しません。<strong>物理サーバーのSSHプロセスに割り当てたポートと同じポートを使用しないでください。</strong></small></p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="box box-primary">
                ...
                <div class="box-body row">
                    <div class="form-group col-sm-6">
                        ...
                        <p class="text-muted"><small>デーモンマスターキーをリセットすると、古いキーからのすべてのリクエストが無効になります。このキーはサーバーの作成や削除を含むデーモン上のすべての機密操作に使用されます。セキュリティのため、定期的にこのキーを変更することをお勧めします。</small></p>
                    </div>
                </div>
