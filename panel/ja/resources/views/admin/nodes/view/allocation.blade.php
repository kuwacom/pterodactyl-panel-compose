...
@section('content-header')
    <h1>{{ $node->name }}<small>このノード上のサーバーが利用可能な割り当てを管理します。</small></h1>
    <ol class="breadcrumb">
    ...
    <div class="col-sm-4">
        <form action="{{ route('admin.nodes.view.allocation', $node->id) }}" method="POST">
            <div class="box box-success">
                <div class="box-header with-border">
                    <h3 class="box-title">新しい割り当てを追加</h3>
                </div>
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <div>
                            ...
                            <p class="text-muted small">ポートを割り当てるIPアドレスをここに入力してください。</p>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            ...
                            <p class="text-muted small">個別のポートまたはポート範囲をカンマまたはスペース区切りで入力してください。</p>
                        </div>
                    </div>
                </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">IPブロックの割り当てを削除</h4>
            </div>
    ...
    function deleteSelected() {
        ...
        if (selectedItems.length !== 0) {
            ...
            if (selectedItems.length > 5) {
                formattedItems += '、他 ' + (selectedItems.length - 5) + ' 件';
            }

            swal({
                type: 'warning',
                title: '',
                text: '以下の割り当てを削除してもよろしいですか: ' + formattedItems + '?',
                html: true,
                showCancelButton: true,
                ...
                $.ajax({
                    ...
                    swal({
                        ...
                        title: 'おっと！',
                        html: true,
                        text: 'これらの割り当ての削除中にエラーが発生しました。もう一度お試しください。',
                    });
                });
            });
        } else {
