...
@section('content-header')
    <h1>ロケーション<small>ノードを割り当てて分類しやすくするための全ロケーション。</small></h1>
    <ol class="breadcrumb">
    ...
    <div class="col-xs-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">ロケーション一覧</h3>
                <div class="box-tools">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <p class="text-muted small">このロケーションを他と区別するための短い識別子。1〜60文字である必要があります。例: <code>us.nyc.lvl3</code>。</p>
                        </div>
                        <div class="col-md-12">
                            <label for="pLongModal" class="form-label">説明</label>
                            <textarea name="long" id="pLongModal" class="form-control" rows="4"></textarea>
                            <p class="text-muted small">このロケーションのより詳細な説明。191文字未満である必要があります。</p>
                        </div>
                    </div>
                </div>
