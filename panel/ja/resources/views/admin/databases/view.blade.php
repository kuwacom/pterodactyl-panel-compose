...
@section('content-header')
    <h1>{{ $host->name }}<small>このデータベースホストに関連するデータベースと詳細を表示。</small></h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body">
                   ...
                   <div class="form-group">
                       ...
                       <input type="text" id="pHost" name="host" class="form-control" value="{{ old('host', $host->host) }}" />
                        <p class="text-muted small">パネルからこのMySQLホストに接続して新しいデータベースを追加する際に使用するIPアドレスまたはFQDN。</p>
                   </div>
                   <div class="form-group">
                   ...
                   <div class="form-group">
                       ...
                       <select name="node_id" id="pNodeId" class="form-control">
                        ...
                        <p class="text-muted small">この設定は、選択したノード上のサーバーにデータベースを追加する際に、このデータベースホストをデフォルトにする以外には何もしません。</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="box-body">
                   ...
                   <div class="form-group">
                       ...
                       <input type="password" name="password" id="pPassword" class="form-control" />
                        <p class="text-muted small">定義されたアカウントのパスワード。割り当てられたパスワードを引き続き使用する場合は空欄のままにしてください。</p>
                   </div>
                   <hr />
                    <p class="text-danger small text-left">このデータベースホストに定義されたアカウントは<strong>必ず</strong> <code>WITH GRANT OPTION</code> 権限を持っている必要があります。定義されたアカウントにこの権限がない場合、データベース作成のリクエストは<em>失敗します</em>。<strong>このパネルに定義したものと同じMySQLアカウント詳細を使用しないでください。</strong></p>
                </div>
