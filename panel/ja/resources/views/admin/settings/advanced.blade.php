...
@section('content-header')
    <h1>詳細設定<small>Pterodactyl の詳細設定を行います。</small></h1>
    <ol class="breadcrumb">
                        ...
                        <div class="row">
                            <div class="form-group col-md-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-muted small">有効にすると、ログインフォームとパスワードリセットフォームでサイレント captcha チェックを行い、必要に応じて表示される captcha を表示します。</p>
                                </div>
                            </div>
                            <div class="form-group col-md-4">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-muted small">サイトと Google 間の通信に使用されます。秘密として保管してください。</p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="alert alert-warning no-margin">
                                        現在、このパネルに同梱されている reCAPTCHA キーを使用しています。セキュリティ向上のため、あなたのウェブサイトに固有の<a href="https://www.google.com/recaptcha/admin">新しい非表示 reCAPTCHA キーを生成</a>することを推奨します。
                                    </div>
                                </div>
                            </div>
                        @endif
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <div>
                                    ...
                                    <p class="text-muted small">エラーをスローする前に接続が開かれるのを待つ時間（秒単位）。</p>
                                </div>
                            </div>
                            <div class="form-group col-md-6">
                                ...
                                <div>
                                    ...
                                    <p class="text-muted small">エラーをスローする前にリクエストが完了するのを待つ時間（秒単位）。</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="form-group col-md-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-muted small">有効にすると、ユーザーはフロントエンド経由でサーバーの新しい割り当てを自動的に作成できるようになります。</p>
                                </div>
                            </div>
                            <div class="form-group col-md-4">
