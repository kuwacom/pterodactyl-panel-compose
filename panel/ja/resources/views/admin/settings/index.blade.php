...
@section('content-header')
    <h1>パネル設定<small>Pterodactyl をお好みに合わせて設定します。</small></h1>
    <ol class="breadcrumb">
                        ...
                        <div class="row">
                            <div class="form-group col-md-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-muted"><small>パネル全体やクライアントに送信されるメールで使用される名前です。</small></p>
                                </div>
                            </div>
                            <div class="form-group col-md-4">
                                ...
                                <div>
                                    <div class="btn-group" data-toggle="buttons">
                                        ...
                                        <label class="btn btn-primary @if ($level == 2) active @endif">
                                            <input type="radio" name="pterodactyl:auth:2fa_required" autocomplete="off" value="2" @if ($level == 2) checked @endif> すべてのユーザー
                                        </label>
                                    </div>
                                    <p class="text-muted"><small>有効にすると、選択したグループに該当するアカウントは、パネルを利用するために2要素認証の有効化が必須となります。</small></p>
                                </div>
                            </div>
                            <div class="form-group col-md-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-muted"><small>UIコンポーネントをレンダリングする際に使用するデフォルト言語。</small></p>
                                </div>
                            </div>
                        </div>
                    </div>
