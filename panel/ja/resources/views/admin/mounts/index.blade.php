...
@section('content-header')
    <h1>マウント<small>サーバーの追加マウントポイントを設定・管理します。</small></h1>
    <ol class="breadcrumb">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <p class="text-muted small">このマウントを他と区別するための一意の名前。</p>
                            </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <p class="text-muted small">このマウントのより詳細な説明。191文字未満である必要があります。</p>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <p class="text-muted small">ユーザーが自分でマウントできるようにしますか？</p>
                            </div>
                        </div>
                    </div>
