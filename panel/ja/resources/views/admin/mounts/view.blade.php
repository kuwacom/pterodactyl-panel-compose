                ...
                <form action="{{ route('admin.mounts.view', $mount->id) }}" method="POST">
                    <div class="box-body">
                        <div class="form-group">
                            <label for="PUniqueID" class="form-label">一意ID</label>
        ...
        $(document).ready(function() {
            ...
            $('button[data-action="detach-egg"]').click(function (event) {
                ...
                $.ajax({
                    ...
                    swal({ type: 'success', title: 'Eggをデタッチしました。' });
                }).fail(function (jqXHR) {
                    console.error(jqXHR);
                    swal({
                        title: 'エラー！',
            ...
            $('button[data-action="detach-node"]').click(function (event) {
                ...
                $.ajax({
                    ...
                    element.parent().parent().addClass('warning').delay(100).fadeOut();
                    swal({ type: 'success', title: 'ノードをデタッチしました。' });
                }).fail(function (jqXHR) {
                    console.error(jqXHR);
                    swal({
                        title: 'エラー！',
