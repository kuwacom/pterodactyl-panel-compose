                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="pNestId" class="form-label">関連付けるNest</label>
                                <div>
                                    ...
                                    <p class="text-muted small">Nestをカテゴリとして考えてください。1つのNestに複数のEggを入れることができますが、それぞれのNestには互いに関連するEggのみを入れることをお勧めします。</p>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="pName" class="form-label">名前</label>
                                <input type="text" id="pName" name="name" value="{{ old('name') }}" class="form-control" />
                                <p class="text-muted small">このEggの識別子として使用する、シンプルで人間が読みやすい名前。ユーザーにはゲームサーバーの種類として表示されます。</p>
                            </div>
                            <div class="form-group">
                                ...
                                <p class="text-muted small">このEggの説明。</p>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <p class="text-muted small">このEggを使用するサーバーで利用可能なDockerイメージ。1行に1つずつ入力してください。複数の値が指定された場合、ユーザーはこのリストからイメージを選択できます。</p>
                            </div>
                            <div class="form-group">
                                ...
                                <p class="text-muted small">このEggで作成される新しいサーバーに使用されるデフォルトの起動コマンド。サーバーごとに必要に応じて変更できます。</p>
                            </div>
                            <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="alert alert-warning">
                                <p>'設定のコピー元'ドロップダウンから別のオプションを選択しない限り、すべての項目は必須です。別のオプションを選択した場合、そのオプションの値を使用するため項目を空欄にできます。</p>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
