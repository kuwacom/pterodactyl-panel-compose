...
@section('content-header')
    <h1>{{ $server->name }}<small>サーバーデータベースを管理。</small></h1>
    <ol class="breadcrumb">
...
<div class="row">
    <div class="col-sm-7">
        <div class="alert alert-info">
            データベースのパスワードは<a href="/server/{{ $server->uuidShort }}/databases">フロントエンドでこのサーバー</a>にアクセスした際に確認できます。
        </div>
            ...
            <form action="{{ route('admin.servers.view.database', $server->id) }}" method="POST">
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <p class="text-muted small">接続を許可するIPアドレスを反映してください。標準的なMySQLの表記を使用します。不明な場合は<code>%</code>のままにしてください。</p>
                    </div>
                    <div class="form-group">
                        ...
                        <p class="text-muted small">このユーザーからデータベースへの同時接続の最大数を反映してください。無制限にする場合は空のままにしてください。</p>
                    </div>
                </div>
