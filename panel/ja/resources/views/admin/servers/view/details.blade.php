...
@section('content-header')
    <h1>{{ $server->name }}<small>オーナーやコンテナを含む、このサーバーの詳細を編集します。</small></h1>
    <ol class="breadcrumb">
            ...
            <form action="{{ route('admin.servers.view.details', $server->id) }}" method="POST">
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <p class="text-muted small">このサーバーに外部識別子を割り当てない場合は空のままにしてください。外部IDはこのサーバーに固有であり、他のサーバーで使用されていない必要があります。</p>
                    </div>
                    <div class="form-group">
                        ...
                        <p class="text-muted small">このフィールドをシステム上の別のユーザーのメールアドレスに変更することで、このサーバーのオーナーを変更できます。変更すると、新しいデーモンセキュリティトークンが自動的に生成されます。</p>
                    </div>
                    <div class="form-group">
