...
@section('content-header')
    <h1>ユーザー<small>システムに登録されているすべてのユーザー。</small></h1>
    <ol class="breadcrumb">
                ...
                <table class="table table-hover">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center"><span data-toggle="tooltip" data-placement="top" title="このユーザーが所有者として設定されているサーバー。">所有サーバー</span></th>
                            <th class="text-center"><span data-toggle="tooltip" data-placement="top" title="このユーザーがサブユーザーとしてアクセスできるサーバー。">アクセス可能</span></th>
                            <th></th>
                        </tr>
                    </thead>
                    <tbody>
