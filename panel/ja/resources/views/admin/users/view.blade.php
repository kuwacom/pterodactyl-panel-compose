...
<div class="row">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            ...
                            <p class="text-muted"><small>このユーザーのパネルをレンダリングする際に使用するデフォルト言語。</small></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="box-body">
                    ...
                    <div class="form-group no-margin-bottom">
                        ...
                        <div>
                            ...
                            <p class="text-muted small">このユーザーのパスワードを同じままにする場合は空欄にしてください。パスワードが変更されてもユーザーには通知されません。</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <div>
                            ...
                            <p class="text-muted"><small>「はい」に設定すると、ユーザーに完全な管理者権限が付与されます。</small></p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="col-xs-12">
        <div class="box box-danger">
            ...
            <div class="box-body">
                <p class="no-margin">このアカウントを削除するには、このアカウントに関連付けられたサーバーが存在しない必要があります。</p>
            </div>
            <div class="box-footer">
                <form action="{{ route('admin.users.view', $user->id) }}" method="POST">
                    {!! csrf_field() !!}
