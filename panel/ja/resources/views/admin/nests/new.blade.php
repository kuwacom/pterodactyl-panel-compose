...
@section('content-header')
    <h1>新規Nest<small>すべてのノードにデプロイする新しいNestを設定します。</small></h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <div>
                            ...
                            <p class="text-muted"><small>これはNest内のすべてのEggを網羅する説明的なカテゴリ名である必要があります。</small></p>
                        </div>
                    </div>
                    <div class="form-group">
